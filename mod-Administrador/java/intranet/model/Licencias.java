...
public class Licencias {
	...
	public Licencias(int sku, String descripcion, String tipo_soporte, Date f_inicial_licencia, Date f_final_licencia,
			int cantidad, int clientes_nit) {
		super();
		this.sku = sku;
	...
	public String toString() {
		return "Licencias [sku=" + sku + ", descripcion=" + descripcion + ", tipo_soporte=" + tipo_soporte
