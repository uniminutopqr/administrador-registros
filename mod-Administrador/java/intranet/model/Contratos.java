...
public class Contratos {
	...
	public Contratos(int id_contrato, String ejecutivo, String tipo_contrato, String horario, Date f_inicio,
	...
	public String toString() {
		return "Contratos [id_contrato=" + id_contrato + ", ejecutivo=" + ejecutivo + ", tipo_contrato=" + tipo_contrato
				+ ", horario=" + horario + ", f_inicio=" + f_inicio + ", f_final=" + f_final + ", num_visitas="
				+ num_visitas + ", informe=" + informe + ", descripcion=" + descripcion + ", nombre_maquina="
				+ nombre_maquina + ", sistema_op=" + sistema_op + ", servicio=" + servicio + ", observaciones="
				+ observaciones + ", alcance_servicio=" + alcance_servicio + ", clientes_nit=" + clientes_nit + "]";
	}
