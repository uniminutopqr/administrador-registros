...
public class Empleados {
	...
	public Empleados(int id_empleado, String cargo, String funciones, String correo_coorporativo,
	...
	public String toString() {
		return "Empleados [id_empleado=" + id_empleado + ", cargo=" + cargo + ", funciones=" + funciones
