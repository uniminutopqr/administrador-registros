...
public class PersonasConverter {
	...
	public PersonasConverter(int numero_documento, String tipo_documento, String nombres, String apellidos,
			String telefono_uno, String telefono_dos, String direccion, String correo_personal) {
		super();
	...
	public String toString() {
		return "PersonasConverter [numero_documento=" + numero_documento + ", tipo_documento=" + tipo_documento
				+ ", nombres=" + nombres + ", apellidos=" + apellidos + ", telefono_uno=" + telefono_uno
				+ ", telefono_dos=" + telefono_dos + ", direccion=" + direccion + ", correo_personal=" + correo_personal
				+ "]";
	}
