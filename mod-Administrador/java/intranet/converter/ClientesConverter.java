...
public class ClientesConverter {
	...
	public ClientesConverter(int nit, String razon_social, String direccion, String ciudad, String telefono,
	...
	public String toString() {
		return "ClientesConverter [nit=" + nit + ", razon_social=" + razon_social + ", direccion=" + direccion
				+ ", ciudad=" + ciudad + ", telefono=" + telefono + ", encargado_general=" + encargado_general
